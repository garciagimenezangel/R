...
otherNames = c("bombus.pratorum", "Bombus.pratorum", "Bombus_ pratorum", "Bombus_pratorum", "B. pratorum", "B_pratorum", "B..pratorum")  # other names of the species in the OBServ database. See "OBservData\Thesaurus_Pollinators\organism_guild_META_STUDIES.csv"
