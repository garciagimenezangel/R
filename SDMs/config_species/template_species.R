...
species = "SPECIES"
otherNames = c("OTHER NAMES")  # other names of the species in the OBServ database. See "OBservData\Thesaurus_Pollinators\organism_guild_META_STUDIES.csv"
yrFrom  = 1900
yrTo    = 2100
excludeNames = c("GENUS SPP") # any pollinator name equal to these strings is not considered as a candidate absence point
