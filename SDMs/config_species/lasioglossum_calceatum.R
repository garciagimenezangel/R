...
otherNames = c("Lasioglossum_ calceatum", "Lasioglossum_calceatum", "Lasioglossum.calceatum")  # other names of the species in the OBServ database. See "OBservData\Thesaurus_Pollinators\organism_guild_META_STUDIES.csv"
yrFrom  = 1988
yrTo    = 2100
