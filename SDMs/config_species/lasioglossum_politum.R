...
species = "Lasioglossum politum"
otherNames = c("Lasioglossum_ politum", "Lasioglossum_politum", "Lasioglossum.politum")  # other names of the species in the OBServ database. See "OBservData\Thesaurus_Pollinators\organism_guild_META_STUDIES.csv"
yrFrom  = 1988
yrTo    = 2100
