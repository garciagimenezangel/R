...
otherNames = c("bombus.hortorum", "Bombus.hortorum", "Bombus_ hortorum", "Bombus_hortorum", "B. hortorum", "B_hortorum", "B..hortorum")  # other names of the species in the OBServ database. See "OBservData\Thesaurus_Pollinators\organism_guild_META_STUDIES.csv"
yrFrom  = 1988
yrTo    = 2100
